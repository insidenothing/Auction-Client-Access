<?
include 'header.php';
portal_log("Draper DC Ad Cost Report", $user[contact_id]);
...
$q1 = "SELECT * FROM schedule_items WHERE sale_date > '$today' AND attorneys_id = '21' AND state='DC' AND private='' ORDER BY sale_date, sort_time "; 

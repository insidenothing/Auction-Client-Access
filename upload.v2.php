...
$link1 = "http://portal.hwestauctions.com/$target_path"; 
...
$link2 = "http://portal.hwestauctions.com/$target_path"; 
...
$link3 = "http://portal.hwestauctions.com/$target_path"; 
...
addNote($newID,'<li>'.date('g:iA n/d/y').' '.$user['name'].': Portal Upload</li>');
...
";
			...
			$command = 'echo "'.$print.'" | a2ps --portrait --columns=1 --rows=1 -P '.$printer;
			exec($command);
